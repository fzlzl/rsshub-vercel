...
// 色花堂
router.get('/dsndsht/picture/:subforumid', lazyloadRouteHandler('./routes/dsndsht/index'));
router.get('/dsndsht/bt/:subforumid?', lazyloadRouteHandler('./routes/dsndsht/index'));
router.get('/dsndsht/:subforumid?/:type?', lazyloadRouteHandler('./routes/dsndsht/index'));
router.get('/dsndsht/:subforumid?', lazyloadRouteHandler('./routes/dsndsht/index'));
router.get('/dsndsht', lazyloadRouteHandler('./routes/dsndsht/index'));
// 麻豆区
router.get('/madouqu', lazyloadRouteHandler('./routes/madouqu/index'));
// 麻豆区-锅锅酱
router.get('/ma-guoguo', lazyloadRouteHandler('./routes/ma-guoguo/index'));
// 麻豆区-糖心
router.get('/ma-tangxin', lazyloadRouteHandler('./routes/ma-tangxin/index'));
// 麻豆区-cola酱
router.get('/ma-cola', lazyloadRouteHandler('./routes/ma-cola/index'));
// avgosu
router.get('/avgosu', lazyloadRouteHandler('./routes/avgosu/index'));
// 桃花族-麻豆传媒
router.get('/thzu', lazyloadRouteHandler('./routes/thzu/index'));
